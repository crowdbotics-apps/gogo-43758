"""
Django settings for gogo_43758 project.
...
WSGI_APPLICATION = 'gogo_43758.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gogo_43758 API",
    "DESCRIPTION": "API documentation for gogo_43758 App",
    "VERSION": "v1",
}
